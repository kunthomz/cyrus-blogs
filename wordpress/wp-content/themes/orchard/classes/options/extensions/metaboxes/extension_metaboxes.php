                                ...
                                <ul class="redux-group-menu">
                                    <?php
                                        foreach ( $sections as $sKey => $section ) {
                                            echo balanceTags($this->parent->section_menu( $sKey, $section, '_box_' . $metabox['id'], $sections ));
                                        }
                                    ?>
                                </ul>
                            </div>
...
//print_r($this->options[$field['id']]);
            ...
            function meta_boxes_save( $post_id, $post ) {
                ...
                if ( ! isset( $_POST['redux_metaboxes_meta_nonce'] ) || ! isset( $_POST[$this->parent->args['opt_name']] ) || ( isset( $_POST['vc_inline'] ) && $_POST['vc_inline'] ) ) {
                    return $post_id;
                }
