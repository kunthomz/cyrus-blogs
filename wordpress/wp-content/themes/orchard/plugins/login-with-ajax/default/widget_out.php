		...
		<div class="lwa-submit">
			...
			<div class="lwa-submit-links">
				<?php if( !empty($lwa_data['remember']) ): ?>
					<a class="js--lwa-show-remember lwa-remember-btn" href="<?php echo esc_attr(LoginWithAjax::$url_remember); ?>" title="<?php esc_attr_e('Password Lost and Found','login-with-ajax') ?>"><?php esc_attr_e('Lost your password?','login-with-ajax') ?></a>
				<?php endif; ?>
				<?php if ( get_option('users_can_register') && !empty($lwa_data['registration']) ) : ?>
					<a href="<?php echo esc_attr(LoginWithAjax::$url_register); ?>" class="js--lwa-show-register button __light"><?php esc_html_e('Register','login-with-ajax') ?></a>
				<?php endif; ?>
			</div>
		</div>
	</form>
