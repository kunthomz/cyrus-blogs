		...
		<?php } else { ?>
			...
			<ul class="wc-thankyou-order-details">
				...
				<li class="date">
					...
					<strong><?php echo wp_kses(date_i18n( get_option( 'date_format' ), strtotime( $order->order_date ) ), 'post'); ?></strong>
				</li>
				<li class="total">
				...
				<li class="method">
					...
					<strong><?php echo wp_kses($order->payment_method_title, 'post'); ?></strong>
				</li>
				<?php } ?>
			</ul>
			<div class="clear"></div>
