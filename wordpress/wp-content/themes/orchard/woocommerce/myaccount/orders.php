...
<?php if ( $has_orders ) { ?>
	...
	<div class="wc-account-orders"><div class="wc-account-orders_lst-w"><table class="wc-account-orders_lst">
		<thead>
			<tr>
				<?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) { ?>
					<th class="wc-account-orders-el_h <?php echo esc_attr( $column_id ); ?>"><span class="nobr"><?php echo esc_html( $column_name ); ?></span></th>
				<?php } ?>
			</tr>
		</thead>
		...
		<tbody>
			<?php foreach ( $customer_orders->orders as $customer_order ) {
				...
				<tr class="order">
					<?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) { ?>
						<td class="wc-account-orders-el_cnt __<?php echo esc_attr( $column_id ); ?>" data-title="<?php echo esc_attr( $column_name ); ?>">
