	...
	<div id="product-tabs">
		<div class="product-tabs-w">
			<ul class="product-tabs">
				...
				<?php } ?>
				<?php if (OrchardOptions::get('single_product--extra_tab')) { ?>

					<li class="product-tabs-el extra_tab">
						<a href="#product-tabs-extra" class="product-tabs-el_lk"><?php echo wp_kses(OrchardOptions::get('single_product--extra_tab_title'), 'post'); ?></a>
					</li>
		...
		<div class="product-tabs-cnt-w">
			...
			<?php if (OrchardOptions::get('single_product--extra_tab')) { ?>
				...
				<div class="product-tabs-cnt" id="product-tabs-extra">
					<div class="container"><?php echo wp_kses(OrchardOptions::get('single_product--extra_tab_content'), 'post'); ?></div>
				</div>
