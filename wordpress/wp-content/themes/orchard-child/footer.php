...
$relPost = PostsHelper::getRelatedPosts();
...
?>
        ...
        <div class="main-cnts-after">
            <?php OrchardHelpers::get_dynamic_area(OrchardOptions::get('content--dynamic_area__after')); ?>
        </div>

        <?php
        if ($relPost && is_single()) : ?>
            <div class="related-posts__wrapper">
                <div class="container">
                    <h4 class="related-posts__heading"><span><?php _e('Related Posts'); ?></span></h4>
                    <ul class="related-posts__items">
                    <?php
                    while ($relPost->have_posts()) :
                        $relPost->the_post();
                        ...
                        <li class="related-posts__item">
                            <div class="related-posts__item-wrap">
                                ...
                                <div class="related-posts__item-info">
                                    <?php if (!empty($firstCategoryName)) : ?>
                                        <p class="related-posts__item-category"><?php echo $firstCategoryName; ?></p>
                                    <?php endif; ?>
                                    <h3 class="post-title"><a href="<?php the_permalink() ?>"><?php the_title() ?></a></h3>
                                    <div class="related-posts__item-desc"><?php the_excerpt() ?></div>
                                    <div class="related-posts__item-action">
        ...
        <footer class="
            main-f
            js--main-f
            <?php if (OrchardOptions::get('footer--fixed')) { echo 'js--main-f-fixed'; } ?>
        "><div class="main-f-inner js--main-f-inner">
            ...
            if (
                OrchardOptions::get('bottom_footer') &&
                !(function_exists('is_account_page') && is_account_page() && !is_user_logged_in())
            ) {
        ...
        <?php if (OrchardOptions::get('general--go_to_top')) { ?>
    ...
    <?php if (OrchardOptions::get('general--typekit_kit_id')) { ?>
        <script src="https://use.typekit.net/<?php echo esc_attr(OrchardOptions::get('general--typekit_kit_id')); ?>.js"></script>
