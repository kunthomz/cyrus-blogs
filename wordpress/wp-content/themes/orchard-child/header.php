...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-X0HH8C2L72"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'G-X0HH8C2L72');
</script>	
...
<body <?php body_class(); ?>>
    ...
    ">
        ...
        <header>
            ...
            if (OrchardHelpers::is_title_wrapper() && have_posts() && !is_search()) {
